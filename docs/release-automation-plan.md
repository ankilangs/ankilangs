...
### Phase 3: Website Pages (Manual First Pass)

**Goal:** Create visual output early for feedback before building automation

1. Define Hugo template for deck pages
2. Manually create initial deck pages from content files (copy-paste approach)
3. Setup screenshot directories (symlink or copy)
4. Update main page to link to deck pages
5. Add deck listing page
6. **Review and iterate on design/layout with user feedback**

### Phase 4: Content Generation Tooling

**Goal:** Automate what was done manually in Phase 3

1. Implement changelog parser (extract version blocks)
2. Implement `al-tools generate-website` (automates Phase 3 manual work)
3. Implement `al-tools generate-ankiweb`
4. Test generated content matches manually created pages
5. Regenerate all pages with tooling to verify

### Phase 5: Core Release Flow
...
### Phase 6: VCS & GitHub Integration
